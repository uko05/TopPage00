document.addEventListener("DOMContentLoaded", () => {
  ...
  const dict = {
    ja: {
      ...
      cardPlayMaker: "原神・スタレ画面メーカー",
      cardGazou: "画像切り抜き連番保存ツール",
      cardStorage17: "画像保管庫",
      cardFriendBoard: "フレンド募集掲示板",
    ...
    en: {
      ...
      cardPlayMaker: "Genshin/StarRail Screen Maker(JP Only)",
      cardGazou: "Image Crop Tool(JP Only)",
      cardStorage17: "Image Storage(JP Only)",
      cardFriendBoard: "Friend Recruitment Board(JP Only)",
